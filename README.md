...
> [!TIP]
> Если вы запустите `pyfetch` на другом дистрибутиве, информация о системе отобразится корректно, но вы увидите надпись о том, что ваш дистрибутив не имеет логотипа.
